...
//   Version: 1.0.2 11/17/2013 BeiJing China [Updated 01/25/2015]        //
//                                                                       //
//   Algorithm:                                                          //
//                                                                       //
//   [][] [][]   [][]            [][]   [][]          [][]   [][] [][]   //
...
int get_argv(int argc, string* argv)
{
    ...
    else if ( argc == 2 )
    {
       ...
       {
            printf("Tetris Game  Version 1.0.2 [Updated 01/25/2015]\n");
            return 1;
       }
       else
       {
...
void board_notify()
{
     ...
     printf("\e[38;5;106;1m\e[%d;%dHTetris Game  Version 1.0.2\n", toph+19, dist);
     printf("\e[%d;%dHYongYe <complex.invoke@gmail.com>\e[%d;%dH11/17/2013 BeiJing China [Updated 01/25/2015]", toph+20, dist, toph+21, dist);
}
